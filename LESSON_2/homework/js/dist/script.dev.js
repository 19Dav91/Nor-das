"use strict"; // 23.1 Дана переменная со значением '5px' и переменная со значением '6px'. Найдите сумму пикселей из 
//      значений этих переменных и выведите ее на экран.

var a = '5px';
var b = '6px';
var sum = parseInt(a) + parseInt(b);
console.log(sum + "px"); // 23.2 Дана переменная со значением '5.5px' и переменная со значением '6.25px'. Найдите сумму пикселей 
...
for (var i = 111; i <= 121; i++) {
  var str = String(i);
  var res = parseInt(str[0]) + parseInt(str[1]);
  console.log(res);
}