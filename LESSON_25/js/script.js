...
// hayk.addProject(p1);
// document.cloneNode(par);
// console.log(hayk.projects);
// hayk.addProject(new Project("Basic Store", ["AngularJS", "PHP"]));
...
//   console.log(hayk.projects);
//   hayk.addProject(new Project("Basic Store", ["AngularJS", "PHP"]));
//   console.log(hayk.toString());
//   hayk.addProject(new Project("Social Network", ["Node.js", "React.js"]));
//   let par2 = document.createElement('h1');
//   document.body.appendChild(par2);
